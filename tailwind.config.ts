  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 30px hsl(var(--brand-green) / 0.3)" },
          "50%": { boxShadow: "0 0 60px hsl(var(--brand-green) / 0.6)" },
        },
        "float": {
        ...
        "glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--brand-red) / 0.5)" },
          "50%": { boxShadow: "0 0 40px hsl(var(--brand-red) / 0.8)" },
        },
        "shimmer": {
